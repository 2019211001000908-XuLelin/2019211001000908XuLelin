            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="address">
                        ...
                        <p>No. 808, Shuanggang East Street, Economic and Technological Development Zone, Nanchang,
                            Jiangxi E-mail\: hdjd@ecjtu.edu.cn</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                ...
                <p class="pull-left" style="width: 178px; margin-left: 300px; ">Are you admin?<a
                        href='<%=basePath1+"admin/home"%>'>Click Here</a></p>
                <p class="pull-right">Designed by <span><a target="_blank"
                                                           href="http://www.ecjtu.jx.cn/">ECJTU</a></span></p>
            </div>
        </div>
    </div>
